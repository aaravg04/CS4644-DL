...
def train(
    ...
    if accelerator.is_main_process:
        if not os.path.exists(f"/home/hice1/ssingh709/scratch/runs/{model_arch}/{dataset}/{saved_name}"):
            os.makedirs(f"/home/hice1/ssingh709/scratch/runs/{model_arch}/{dataset}/{saved_name}")
        writer = SummaryWriter(f"/home/hice1/ssingh709/scratch/runs/{model_arch}/{dataset}/{saved_name}")
    else:
        writer = None
    step = 0
    ...
    for epoch in range(num_epochs):
        ...
        if save_model:
            if (epoch + 1) % save_every == 0 and accelerator.is_main_process:
                ...
                if not os.path.exists(f"/home/hice1/ssingh709/scratch/checkpoints/{model_arch}/{dataset}/{saved_name}"):
                    os.makedirs(f"/home/hice1/ssingh709/scratch/checkpoints/{model_arch}/{dataset}/{saved_name}")
                filename = f"/home/hice1/ssingh709/scratch/checkpoints/{model_arch}/{dataset}/{saved_name}/checkpoint_epoch_{epoch + 1}.pth.tar"
                ...
                if not os.path.exists(f'/home/hice1/ssingh709/scratch/metric_logs/{model_arch}/{dataset}/{saved_name}'):
                    os.makedirs(f'/home/hice1/ssingh709/scratch/metric_logs/{model_arch}/{dataset}/{saved_name}')
                metrics_file_path = f'/home/hice1/ssingh709/scratch/metric_logs/{model_arch}/{dataset}/{saved_name}//train_val_to_epoch_{epoch+1}.json'
